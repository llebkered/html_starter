...
/* ================= */
/* Javascript */
var jsFiles = [ // add js files to array
];
...
*/
gulp.task('default', ['sass', 'images', 'svgstore', 'svgfallback', 'scripts', 'browser-sync', 'watch']);